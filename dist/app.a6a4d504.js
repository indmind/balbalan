...
},{}],"src/utils/route.js":[function(require,module,exports) {
"use strict";
...
function setPage(page) {
  ...
  if (history.pushState) {
    ...
    location.hash = "/#/".concat(page); // window.history.replaceState({page: 3}, "title 3", "?page=3")
...
var ApiService = /*#__PURE__*/function () {
  ...
  _createClass(ApiService, [{
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.prev = 1;
                _context.next = 4;
                return fetch(new URL(path, this.API_ENDPOINT), _objectSpread({
                  method: 'GET',
                  headers: {
    ...
    key: "getStandings",
    value: function () {
      var _getStandings = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(leagueId) {
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return this.fetch("competitions/".concat(leagueId, "/standings"));
      ...
      function getStandings(_x3) {
        return _getStandings.apply(this, arguments);
      }
    ...
    key: "getTeam",
    value: function () {
      var _getTeam = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(teamId) {
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.next = 2;
                return this.fetch("teams/".concat(teamId));
...
},{}],"src/pages/home/index.js":[function(require,module,exports) {
"use strict";
...
function run() {
  ...
  var teamInfoContainer = document.querySelector('.container.team-info');
  var standingsContainer = document.querySelector('.row.standings');
  var cardBanner = document.querySelector('#banner-card');
  updatePage();
  window.onhashchange = updatePage;

  appNavbar.onchange = function (leagueId) {
    loadStandings(leagueId);
  };

  function updatePage(event) {
    var hrefPaths = window.location.href.split('/'); //  default page and value

    var page = 'league';
    var value = '2001';

    if (hrefPaths.length < 5) {
      (0, _route.setPage)("".concat(page, "/").concat(value), true);
    } else {
    ...
    switch (page) {
      ...
      default:
        M.toast({
          html: "Page ".concat(page, " not found")
        });
    }
  }
  ...
  function handleError(error) {
    if (error.message === 'Failed to fetch') {
      ...
      return M.toast({
        html: '403 Cannot access the resource'
      });
    }
  ...
  function loadStandings(_x) {
    return _loadStandings.apply(this, arguments);
  }

  function _loadStandings() {
    _loadStandings = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(leagueId) {
      var _yield$api$getStandin, competition, season, standings, error;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              _context.next = 3;
              return api.getStandings(leagueId);

            case 3:
              _yield$api$getStandin = _context.sent;
              competition = _yield$api$getStandin.competition;
              season = _yield$api$getStandin.season;
              standings = _yield$api$getStandin.standings;
              error = _yield$api$getStandin.error;
              ...
              document.getElementById('subvalue').innerText = new Date(season.endDate).toDateString();
              standingsContainer.innerHTML = '';
              standings[0].table.forEach(function (team) {
                var teamElement = document.createElement('team-item');
                teamElement.addEventListener('click', function () {
                  return onTeamClick(team);
                });
  ...
  function onTeamClick(team) {
    ...
    (0, _route.setPage)("team/".concat(teamId));
    setTeamDetailData(teamId);
    showTeamDetail();
    document.getElementById('league').innerText = team.team.name;
  }

  function setTeamDetailData(_x2) {
    return _setTeamDetailData.apply(this, arguments);
  }

  function _setTeamDetailData() {
    _setTeamDetailData = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(teamId) {
      var teamDetailElement, team;
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.prev = 0;
              teamDetailElement = document.createElement('team-detail');
            ...
            case 6:
              ...
              document.getElementById('subvalue').innerText = new Date(team.lastUpdated).toDateString();
  ...
  function showTeamDetail() {
    ...
    setTimeout(function () {
      return teamInfoContainer.classList.remove('transparent');
    }, 100);
    setTimeout(function () {
      window.scrollTo({
        top: 0
...
},{"./home.html":"src/pages/home/home.html","../../utils/route":"src/utils/route.js","../../services/api":"src/services/api.js"}],"src/js/main.js":[function(require,module,exports) {
"use strict";
...
var _default = function _default() {
  ...
  function _loadPage() {
    _loadPage = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(page) {
      var content;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.t0 = page;
              _context.next = _context.t0 === 'home' ? 5 : 8;
              break;

            case 5:
              content.innerHTML = _home.default.template;

              _home.default.created();
...
exports.default = _default;
},{"../pages/home":"src/pages/home/index.js"}],"lib/js/materialize.min.js":[function(require,module,exports) {
var define;
...
},{}],"src/component/nav.js":[function(require,module,exports) {
"use strict";
...
var Navbar = /*#__PURE__*/function (_HTMLElement) {
  ...
  function Navbar() {
    ...
    _this.sidenavInstance = null;
    _this._selectedLeague = '2001';
  ...
  _createClass(Navbar, [{
    ...
    value: function connectedCallback() {
      this.render();
      this.sidenavInstance = M.Sidenav.init(document.querySelector('.sidenav'));
    ...
    value: function setupClickListeners() {
      ...
      this.querySelectorAll('.sidenav a, .topnav a').forEach(function (element) {
        element.addEventListener('click', function (_ref) {
          var target = _ref.target;

          _this2.sidenavInstance.close();

          _this2._selectedLeague = target.dataset.value;
          (0, _route.setPage)("league/".concat(_this2._selectedLeague), true);

          if (_this2._changeEvent) {
            _this2._changeEvent(_this2._selectedLeague);
          }
        });
      });
    }
    ...
    set: function set(action) {
      ...
      if (!action) {
        this.sidenavInstance = M.Sidenav.init(this.querySelector('.sidenav'));
        this.setupClickListeners();
        return;
      }
...
},{"../utils/route":"src/utils/route.js"}],"src/component/team-item.js":[function(require,module,exports) {
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
var TeamItem = /*#__PURE__*/function (_HTMLElement) {
  _inherits(TeamItem, _HTMLElement);

  var _super = _createSuper(TeamItem);
  ...
  _createClass(TeamItem, [{
    ...
    key: "render",
    value: function render() {
      var standColor = 'grey darken-2';

      switch (this._team.position) {
        case 1:
          standColor = 'orange darken-1';
          break;

        case 2:
          standColor = 'blue-grey lighten-1';
          break;

        case 3:
          standColor = 'brown lighten-1';
          break;
      }

      this.innerHTML =
      /* html*/
      "\n      <style>\n        ".concat(this.styles, "\n      </style>\n      <div class=\"col s12\">\n        <div class=\"team-item waves-effect\">\n          <img \n            src=\"").concat(this._team.team.crestUrl.replace(/^http:\/\//i, 'https://'), "\"\n            alt=\"").concat(this._team.team.name, " Logo\"\n            onerror=\"this.src = '/assets/images/icon.svg'\"\n          >\n          <div class=\"team-item-content\">\n            <span class=\"badge ").concat(standColor, " white-text\">\n              ").concat(this._team.position, "\n            </span>\n            <span>").concat(this._team.team.name, "d</span>\n            <hr>\n            <div>\n              <span class=\"stat teal-text\">\n                ").concat(this._team.won, "<span>won</span>\n              </span>\n              <span class=\"stat orange-text\">\n                ").concat(this._team.draw, "<span>draw</span>\n              </span>\n              <span class=\"stat red-text\">\n                ").concat(this._team.lost, "<span>lost</span>\n              </span>\n              <span class=\"badge stat\">\n                ").concat(this._team.points, "<span>pts</span>\n              </span>\n            </div>\n          </div>\n        </div>\n      </div>\n    ");
    }
  }, {
    key: "team",
...
},{}],"src/component/team-detail.js":[function(require,module,exports) {
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
var TeamDetail = /*#__PURE__*/function (_HTMLElement) {
  _inherits(TeamDetail, _HTMLElement);

  var _super = _createSuper(TeamDetail);
  ...
  _createClass(TeamDetail, [{
    ...
    value: function render() {
      if (!this._team) {
        return this.innerHTML = "\n        <style>\n          ".concat(this.loaderStyle, "\n        </style>\n        <div class=\"loader\">Loading...</div>\n      ");
      }

      this.innerHTML =
      /* html*/
      "\n      <style>\n        ".concat(this.styles, "\n      </style>\n      <div class=\"row\">\n        <div class=\"col s4\"> \n          <img \n            class=\"materialboxed\" width=\"100%\"\n            src=\"").concat(this._team.crestUrl.replace(/^http:\/\//i, 'https://'), "\"\n            alt=\"").concat(this._team.shortName, " Logo\"\n            onerror=\"this.src = '/assets/images/icon.svg'\"\n          >\n        </div>\n        <div class=\"col s8\">\n            <h5 class=\"sort-name\">\n              ").concat(this._team.shortName, "/<b>").concat(this._team.tla, "</b>\n            </h5>\n            <div class=\"detail-item\">\n              <small>Founded</small>\n              <span class=\"badge teal white-text\">\n                ").concat(this._team.founded || '-', "\n              </span>\n            </div>\n            <div class=\"detail-item\">\n              <small><i class=\"material-icons\">public</i></small>\n              <span class=\"badge\">\n                <a href=\"").concat(this._team.website, "\">\n                  ").concat(this._team.website.replace(/(^\w+:|^)\/\//, '') || '-', "\n                </a>\n              </span>\n            </div>\n            <div class=\"detail-item\">\n              <small><i class=\"material-icons\">color_lens</i></small>\n              <span class=\"badge truncate\">\n                ").concat(this._team.clubColors || '-', "\n              </span>\n            </div>\n            <div class=\"detail-item\">\n              <small><i class=\"material-icons\">event_seat</i></small>\n              <span class=\"badge\">").concat(this._team.venue || '-', "</span>\n            </div>\n        </div>\n        <br/>\n        <div class=\"col 12\">\n          <h4>Squads</h4>\n          <table id=\"squad-table\">\n            <thead>\n              <tr>\n                  <th>#</th>\n                  <th>Name</th>\n                  <th>Pos</th>\n                  <th>Nat</th>\n              </tr>\n            </thead>\n\n            <tbody>\n            ").concat(this._team.squad.map(function (player) {
        return (
          /* html*/
          "\n              <tr>\n                <td>".concat(player.shirtNumber || '-', "</td>\n                <td>").concat(player.name || '-', "</td>\n                <td>").concat(player.position || '-', "</td>\n                <td>").concat(player.nationality || '-', "</td>\n              </tr>\n            ")
        );
      }).join(''), "\n            </tbody>\n          </table>\n        </div>\n      </div>\n    ");
    }
  }, {
...
require("../lib/js/materialize.min.js");

require("./component/nav.js");

require("./component/team-item.js");

require("./component/team-detail.js");
...
if (document.readyState !== 'loading') {
  ...
  window.addEventListener('DOMContentLoaded', _main.default);
}
...
},{"regenerator-runtime":"node_modules/regenerator-runtime/runtime.js","./js/main":"src/js/main.js","../lib/js/materialize.min.js":"lib/js/materialize.min.js","./component/nav.js":"src/component/nav.js","./component/team-item.js":"src/component/team-item.js","./component/team-detail.js":"src/component/team-detail.js","/home/indmind/Projects/web/dicoding/balbalan/service-worker.js":[["service-worker.js","service-worker.js"],"service-worker.js.map","service-worker.js"]}],"../../../../.nvm/versions/node/v10.15.3/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}],"../../../../.nvm/versions/node/v10.15.3/lib/node_modules/parcel-bundler/src/builtins/bundle-loader.js":[function(require,module,exports) {
...
},{"./bundle-url":"../../../../.nvm/versions/node/v10.15.3/lib/node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"../../../../.nvm/versions/node/v10.15.3/lib/node_modules/parcel-bundler/src/builtins/loaders/browser/html-loader.js":[function(require,module,exports) {
module.exports = function loadHTMLBundle(bundle) {
  return fetch(bundle).then(function (res) {
    return res.text();
  });
};
},{}],"../../../../.nvm/versions/node/v10.15.3/lib/node_modules/parcel-bundler/src/builtins/loaders/browser/js-loader.js":[function(require,module,exports) {
...
var b=require("../../../../.nvm/versions/node/v10.15.3/lib/node_modules/parcel-bundler/src/builtins/bundle-loader.js");b.register("html",require("../../../../.nvm/versions/node/v10.15.3/lib/node_modules/parcel-bundler/src/builtins/loaders/browser/html-loader.js"));b.register("js",require("../../../../.nvm/versions/node/v10.15.3/lib/node_modules/parcel-bundler/src/builtins/loaders/browser/js-loader.js"));b.load([["home.1be20427.html","src/pages/home/home.html"]]).then(function(){require("src/app.js");});
},{}]},{},["../../../../.nvm/versions/node/v10.15.3/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js",0], null)
